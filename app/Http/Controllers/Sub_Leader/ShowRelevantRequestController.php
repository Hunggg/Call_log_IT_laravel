...
class ShowRelevantRequestController extends Controller
{
    public function index_hn()
    {
        ...
        return view('database_manager.list_request_congviecyeucau.leader.show_sub_leader_hn')->with([
            'indi_data' => $data
        ]);
    }
    public function index_dn()
    {
        ...
        return view('database_manager.list_request_congviecyeucau.leader.show_sub_leader_dn')->with([
            'indi_data' => $data
        ]);
    }
}
