...
class EditController extends Controller
{
    public function index_hn($id)
    {
        ...
        return view('database_manager.request.member.edit_member_hn')->with(['edit_data'=>$data,'priority_data'=>$priority,'status_data'=>$status,'users_data'=>$users,'team_data'=>$team,'id_user'=>$id_user,'check_status'=>$disabled,'comment_data'=>$ticket_th_data]);
    }
    public function index_dn($id)
    {
        ...
        return view('database_manager.request.member.edit_member_dn')->with(['edit_data'=>$data,'priority_data'=>$priority,'status_data'=>$status,'users_data'=>$users,'team_data'=>$team,'id_user'=>$id_user,'check_status'=>$disabled,'comment_data'=>$ticket_th_data]);
    }
